...
edges_fil = curr_dir + "/" + "highway_edges.txt" # dirname and __file__ (this file) returns the current folder
...
for n1, n2 in permutations(g.nodes,2): #permutations returns all pairs
    ...
    # iterating through the edges in a path, you can calculate the weight of the entire path
        ...
        for path in nx.all_simple_paths(g, source=n1, target=n2):
            ...
            if path_weight < min_path:
                min_path = path_weight

print()
print("shortest path from", n1, "to", n2, ":")
print(path)
print("path_weight", min_path)
